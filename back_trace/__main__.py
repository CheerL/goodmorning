...
if __name__ == '__main__':
    ...
    # parser.add_argument('--max_buy_vol', default=1e11, type=float)
    # parser.add_argument('--min_up_small_buy_vol', default=1900000, type=float)
    
    
    # parser.add_argument('--break_cont_rate', default=-0.223, type=float)
    # parser.add_argument('--buy_up_rate', default=0.001, type=float)
    ...
    # parser.add_argument('--high_back_rate', default=0.136, type=float)
    # parser.add_argument('--high_rate', default=0.167, type=float)
    # parser.add_argument('--low_back_rate', default=0.07, type=float)
    # parser.add_argument('--low_rate', default=0.076, type=float)
    
    # parser.add_argument('--min_cont_rate', default=-0.176, type=float)
    # parser.add_argument('--sell_down_rate', default=-0.005, type=float)
    # parser.add_argument('--up_break_cont_rate', default=-0.076, type=float)
    # parser.add_argument('--up_cont_rate', default=-0.071, type=float)
    # parser.add_argument('--up_near_rate', default=0.67, type=float)
    # parser.add_argument('--up_near_rate_fake', default=0.75, type=float)
    # parser.add_argument('--up_small_cont_rate', default=-0.059, type=float)
    # parser.add_argument('--up_small_loss_rate', default=-0.018, type=float)
