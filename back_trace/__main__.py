...
if __name__ == '__main__':
    ...
    parser.add_argument('--up_small_cont_rate', default=0.9, type=float)
    ...
    # parser.add_argument('--break_cont_rate', default=-0.553, type=float)
    # parser.add_argument('--buy_up_rate', default=0, type=float)
    # parser.add_argument('--clear_rate', default=0.026, type=float)
    # parser.add_argument('--final_modify_rate', default=1, type=float)
    # parser.add_argument('--final_rate', default=0.1, type=float)
    # parser.add_argument('--high_back_rate', default=0.9, type=float)
    # parser.add_argument('--high_rate', default=0.194, type=float)
    # parser.add_argument('--low_back_rate', default=0.6, type=float)
    # parser.add_argument('--low_rate', default=0.9, type=float)
    
    # parser.add_argument('--min_cont_rate', default=0.37, type=float)
    # parser.add_argument('--sell_down_rate', default=0, type=float)
    # parser.add_argument('--up_break_cont_rate', default=-0.084, type=float)
    # parser.add_argument('--up_cont_rate', default=0.9, type=float)
    # parser.add_argument('--up_near_rate', default=0.9, type=float)
    # parser.add_argument('--up_near_rate_fake', default=0.7, type=float)
    # parser.add_argument('--up_small_cont_rate', default=0.875, type=float)
    # parser.add_argument('--up_small_loss_rate', default=0.17, type=float)
