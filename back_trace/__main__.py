...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_hold_days_list', default='2:7')
    ...
    parser.add_argument('--high_rate_list', default='0.1:0.35')
    ...
    parser.add_argument('--low_back_rate_list', default='0:0.09')
    parser.add_argument('--clear_rate_list', default='-0.025:0.025')
    parser.add_argument('--final_rate_list', default='0:0.10')
    parser.add_argument('--stop_loss_rate_list', default='-1')
    parser.add_argument('--min_cont_rate_list', default='-0.2:-0.1')
    parser.add_argument('--break_cont_rate_list', default='-0.4:-0.25')
    parser.add_argument('--up_cont_rate_list', default='-0.2:-0.05')
    parser.add_argument('--min_close_rate_list', default='-0.025:0.025')
    ...
    parser.add_argument('--break_cont_rate', default=-0.31, type=float)
